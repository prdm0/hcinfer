...
The HCbeta constants can be passed through `...`, and the two shape caps can be
supplied independently. A sensitivity check compares the default result with a
small set of alternative settings.
