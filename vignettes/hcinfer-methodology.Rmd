...
Cribari-Neto, F. and da Silva, W. B. (2011). A new heteroskedasticity consistent
covariance matrix estimator for the linear regression model. *AStA Advances in
Statistical Analysis*, 95(2), 129-146.
...
Li, G., Zhang, Z., Zhang, B., and Wang, H. (2016). A modified heteroscedasticity
consistent covariance matrix estimator for the linear regression model.
*Journal of Statistical Computation and Simulation*. doi:10.1080/00949655.2016.1198906.
