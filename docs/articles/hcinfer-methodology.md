...
Li, G., Zhang, Z., Zhang, B., and Wang, H. (2016). A modified
heteroscedasticity consistent covariance matrix estimator for the linear
regression model. *Journal of Statistical Computation and Simulation*.
